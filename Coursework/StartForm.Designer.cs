namespace Coursework
{
    partial class StartForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3.TabIndex = 34;
            label3.Text = "Ваша смена продлится с 08:00 до 20:00. Вам нужно следить за количеством пассажиров на каждой остановке и в случае необходимости высылать дополнительный транспорт";
            // 
            // StartForm
            // 
